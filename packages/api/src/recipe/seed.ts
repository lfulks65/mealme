...
const recipes: SeedRecipe[] = [
  ...
  {
    title: 'Avocado Toast',
    description: 'Crusty sourdough topped with mashed avocado, cherry tomatoes, red pepper flakes, and a squeeze of lemon.',
    cuisine: 'American',
    prep_minutes: 5,
    cook_minutes: 3,
    servings: 2,
    ...
    instructions: [
      ...
      { step_number: 2, instruction: 'Halve avocado, remove pit, and mash flesh with lemon juice and sea salt.' },
      { step_number: 3, instruction: 'Spread mashed avocado generously onto each toast.' },
      { step_number: 4, instruction: 'Top with halved cherry tomatoes and a pinch of red pepper flakes.' },
  ...
  },
  {
    ...
    description: 'Day-old rice wok-tossed with scrambled egg, soy sauce, scallions, and a hint of sesame oil.',
    cuisine: 'Asian',
    prep_minutes: 5,
    cook_minutes: 10,
    servings: 3,
    ...
    instructions: [
      ...
      { step_number: 2, instruction: 'Beat eggs and scramble in the wok until just set; break into small pieces and push aside.' },
  ...
  {
    title: 'Quesadilla',
    description: 'Crispy flour tortilla folded around melted cheddar and jack cheese with optional chicken and peppers.',
    cuisine: 'Mexican',
    prep_minutes: 5,
    cook_minutes: 8,
    servings: 2,
    ...
    instructions: [
      ...
      { step_number: 2, instruction: 'Butter one side of each tortilla and place butter-side down in a medium skillet.' },
      { step_number: 3, instruction: 'Layer cheeses, bell pepper, and chicken on half the tortilla; fold over.' },
      { step_number: 4, instruction: 'Cook 3–4 minutes per side over medium heat until tortilla is golden and cheese is melted.' },
  ...
  {
    title: 'Smoothie Bowl',
    description: 'Thick blended açaí and banana topped with granola, fresh berries, coconut, and a drizzle of honey.',
    cuisine: 'American',
    prep_minutes: 10,
    cook_minutes: 0,
    servings: 2,
  ...
  // ── Keto (2) ────────────────────────────────────────────────────────────
  {
    ...
    description: 'All the burger flavor without the bun — ground beef, bacon, cheddar, pickles, and special sauce over greens.',
    cuisine: 'American',
    prep_minutes: 10,
    cook_minutes: 10,
    servings: 4,
    ...
    instructions: [
      { step_number: 1, instruction: 'Cook bacon in a skillet until crispy; crumble and set aside.' },
      { step_number: 2, instruction: 'In the same skillet, brown ground beef with diced onion over medium-high heat; drain excess fat.' },
      ...
      { step_number: 5, instruction: 'Divide mixed greens among bowls. Top with cheesy beef, crumbled bacon, sliced pickles, and a drizzle of sauce.' },
    ],
  ...
  },
  {
    ...
    description: 'Crispy low-carb pizza crust made from mozzarella and almond flour, topped with pepperoni and marinara.',
    cuisine: 'Italian',
    prep_minutes: 10,
    cook_minutes: 15,
    servings: 4,
    ...
    instructions: [
      { step_number: 1, instruction: 'Microwave mozzarella and cream cheese together in 30-second intervals until fully melted and smooth.' },
      { step_number: 2, instruction: 'Stir in almond flour, egg, and Italian seasoning; knead until a dough forms.' },
      { step_number: 3, instruction: 'Press dough into a 12-inch circle on a parchment-lined baking sheet.' },
      { step_number: 4, instruction: 'Bake at 425°F for 10 minutes until golden and set.' },
      { step_number: 5, instruction: 'Top with marinara and pepperoni; bake 5 more minutes until cheese bubbles. Cool 2 minutes before slicing.' },
    ],
  ...
  // ── Paleo (2) ───────────────────────────────────────────────────────────
  {
    ...
    description: 'Wild-caught salmon fillets grilled with lemon, garlic, and dill — clean, simple, and paleo-perfect.',
    cuisine: 'American',
    prep_minutes: 5,
    cook_minutes: 12,
    servings: 4,
    ...
    instructions: [
      ...
      { step_number: 2, instruction: 'Brush fillets with olive oil and minced garlic; let sit 5 minutes.' },
      { step_number: 3, instruction: 'Preheat grill to medium-high. Place salmon skin-side down; grill 5 minutes.' },
  ...
  },
  {
    ...
    description: 'Diced sweet potatoes sautéed with bell pepper, onion, and ground turkey — a hearty paleo breakfast or dinner.',
    cuisine: 'American',
    prep_minutes: 10,
    cook_minutes: 20,
    servings: 4,
    ...
    instructions: [
      { step_number: 1, instruction: 'Dice sweet potatoes into half-inch cubes; dice bell pepper and onion.' },
      { step_number: 2, instruction: 'Heat coconut oil in a large skillet over medium-high heat. Add sweet potatoes and cook 10 minutes, stirring occasionally.' },
      { step_number: 3, instruction: 'Add bell pepper, onion, and garlic; cook 5 minutes until softened.' },
      { step_number: 4, instruction: 'Push veggies aside and brown ground turkey with smoked paprika, breaking into crumbles, about 6 minutes.' },
      { step_number: 5, instruction: 'Mix everything together, season with salt, and cook 2 more minutes. Garnish with fresh parsley and serve.' },
    ],
    tags: ['american', 'paleo', 'breakfast', 'hash', 'gluten-free', 'dairy-free', 'whole30', 'high-protein'],
    dietary_info: [
      { restriction: 'gluten-free', is_compliant: true },
      { restriction: 'dairy-free', is_compliant: true },
      { restriction: 'vegetarian', is_compliant: false },
  ...
  // ── Weekend / Complex (5) ───────────────────────────────────────────────
  {
    ...
    description: 'Classic French stew of tender beef braised in red wine with mushrooms, pearl onions, and aromatic herbs — the ultimate weekend project.',
    cuisine: 'French',
    prep_minutes: 30,
    cook_minutes: 180,
    servings: 6,
    ...
    instructions: [
      { step_number: 1, instruction: 'Cut beef into 2-inch cubes and pat dry. Season generously with salt and pepper.' },
      { step_number: 2, instruction: 'Render diced bacon in a heavy Dutch oven until crispy; remove and set aside. Brown beef in batches in the bacon fat, 3–4 minutes per side; set aside.' },
      { step_number: 3, instruction: 'Sauté sliced carrots, pearl onions, and garlic in the same pot for 5 minutes. Stir in tomato paste and cook 1 minute.' },
      { step_number: 4, instruction: 'Deglaze with red wine, scraping up all browned bits. Add beef broth and bouquet garni. Return beef and bacon to the pot.' },
      { step_number: 5, instruction: 'Bring to a simmer, cover, and transfer to a 325°F oven. Braise for 2.5 hours until beef is fork-tender.' },
      { step_number: 6, instruction: 'Sauté mushrooms in butter until golden, about 5 minutes. Add to the stew during the last 30 minutes of braising.' },
      { step_number: 7, instruction: 'Discard bouquet garni. Adjust seasoning with salt and pepper. Serve over mashed potatoes or egg noodles.' },
    ],
  ...
  },
  {
    ...
    description: 'Rich tonkotsu-style pork broth with handmade noodles, chashu pork, soft-boiled egg, and all the fixings — a labor of love.',
    cuisine: 'Asian',
    prep_minutes: 45,
    cook_minutes: 360,
    servings: 4,
    ...
    instructions: [
      { step_number: 1, instruction: 'Blanch pork bones in boiling water for 10 minutes; drain and rinse to remove impurities.' },
      { step_number: 2, instruction: 'Return clean bones to a large pot with fresh water, smashed garlic, and sliced ginger. Boil vigorously for 4–6 hours, stirring occasionally to emulsify the broth into a creamy white.' },
      { step_number: 3, instruction: 'Meanwhile, roll and tie pork belly. Sear on all sides, then braise in soy sauce, mirin, and water for 2 hours until tender. Slice chashu when cooled.' },
      { step_number: 4, instruction: 'Make marinated soft-boiled eggs: boil 6.5 minutes, ice bath, peel, then soak in soy-mirin marinade for at least 4 hours.' },
      { step_number: 5, instruction: 'Strain the broth and season with soy sauce, salt, and a splash of mirin to taste.' },
  ...
  {
    title: 'BBQ Brisket',
    description: 'Low-and-slow smoked beef brisket with a dry rub and tangy mop sauce — Texas-style barbecue at its finest.',
    cuisine: 'American',
    prep_minutes: 30,
    cook_minutes: 720,
    servings: 12,
    ...
    instructions: [
      { step_number: 1, instruction: 'Trim brisket fat cap to about ¼ inch. Mix black pepper, salt, garlic powder, onion powder, and paprika into a dry rub.' },
      { step_number: 2, instruction: 'Coat brisket with a thin layer of yellow mustard as a binder, then apply dry rub generously on all sides.' },
      { step_number: 3, instruction: 'Let the rubbed brisket rest in the refrigerator uncovered for at least 8 hours (overnight is best).' },
      { step_number: 4, instruction: 'Set smoker to 225°F with oak or hickory wood. Place brisket fat-side up and smoke for 6 hours, spritzing with apple cider vinegar every hour.' },
      { step_number: 5, instruction: 'When bark is set and internal temp reaches 165°F, wrap tightly in butcher paper. Return to smoker.' },
      { step_number: 6, instruction: 'Continue smoking until internal temperature reaches 203°F and the brisket probes like butter, about 4–6 more hours.' },
      { step_number: 7, instruction: 'Rest brisket wrapped in a towel inside a cooler for at least 1 hour. Slice against the grain and serve with Worcestershire mop sauce.' },
    ],
    tags: ['american', 'bbq', 'smoked', 'texas', 'weekend-project', 'gluten-free', 'dairy-free', 'keto', 'whole30'],
    dietary_info: [
      { restriction: 'gluten-free', is_compliant: true },
      { restriction: 'dairy-free', is_compliant: true },
      { restriction: 'vegetarian', is_compliant: false },
  ...
  {
    title: 'Lasagna',
    description: 'Layer upon layer of pasta, rich meat ragù, creamy béchamel, and bubbling mozzarella — the Italian-American weekend classic.',
    cuisine: 'Italian',
    prep_minutes: 45,
    cook_minutes: 90,
    servings: 8,
    ...
    instructions: [
      { step_number: 1, instruction: 'Brown ground beef and Italian sausage in a large skillet; drain excess fat. Stir in marinara sauce and simmer 20 minutes for the ragù.' },
      { step_number: 2, instruction: 'Make béchamel: melt butter, whisk in flour, cook 1 minute. Gradually add milk, whisking until thick and smooth, about 5 minutes.' },
      { step_number: 3, instruction: 'Mix ricotta with half the Parmesan, an egg, and chopped parsley.' },
      { step_number: 4, instruction: 'Spread a thin layer of ragù on the bottom of a 9×13 baking dish. Layer noodles, ricotta mixture, ragù, béchamel, and mozzarella. Repeat for 3 layers.' },
      { step_number: 5, instruction: 'Top the final layer with remaining mozzarella and Parmesan.' },
      { step_number: 6, instruction: 'Cover with foil and bake at 375°F for 45 minutes. Remove foil and bake 20 more minutes until golden and bubbly.' },
      { step_number: 7, instruction: 'Rest for 15 minutes before slicing so layers set. Serve with a side salad and garlic bread.' },
    ],
  ...
  },
  {
    ...
    description: 'Crusty artisan sourdough with an open crumb and tangy flavor — the quintessential baking weekend project from starter to loaf.',
    cuisine: 'American',
    prep_minutes: 30,
    cook_minutes: 45,
    servings: 8,
    ...
    instructions: [
      { step_number: 1, instruction: 'Mix flour, water, and starter in a large bowl until a shaggy dough forms. Rest 30 minutes (autolyse).' },
      { step_number: 2, instruction: 'Add salt and a splash of water. Pinch and fold the dough until salt is fully incorporated.' },
      { step_number: 3, instruction: 'Perform stretch-and-folds every 30 minutes for the first 2 hours (4 sets total). Let dough bulk ferment at room temperature for 4–6 hours until doubled.' },
      { step_number: 4, instruction: 'Pre-shape dough into a round on a lightly floured surface. Bench rest 20 minutes.' },
      { step_number: 5, instruction: 'Shape into a tight boule or batard. Place seam-side up in a rice-floured banneton. Cover and cold retard in the refrigerator for 12–16 hours.' },
      { step_number: 6, instruction: 'Preheat a Dutch oven inside the oven at 500°F for 1 hour. Score the cold dough with a lame.' },
      { step_number: 7, instruction: 'Bake covered 20 minutes at 500°F, then remove lid, reduce to 450°F, and bake 20–25 minutes until deep golden. Cool completely on a wire rack before slicing.' },
    ],
  ...
  // ── Desserts (3) ────────────────────────────────────────────────────────
  {
    ...
    description: 'Individual dark chocolate cakes with a molten, gooey center that flows when you cut in — pure indulgence.',
    cuisine: 'French',
    prep_minutes: 15,
    cook_minutes: 14,
    servings: 4,
    ...
    instructions: [
      { step_number: 1, instruction: 'Preheat oven to 425°F. Butter and dust 4 ramekins with cocoa powder; place on a baking sheet.' },
      { step_number: 2, instruction: 'Melt dark chocolate and butter together in a double boiler, stirring until smooth. Let cool slightly.' },
      { step_number: 3, instruction: 'Whisk eggs, egg yolks, sugar, and vanilla until pale and thick, about 2 minutes.' },
      { step_number: 4, instruction: 'Fold the chocolate mixture into the egg mixture gently. Sift in flour and fold until just combined — do not overmix.' },
      { step_number: 5, instruction: 'Divide batter among prepared ramekins, filling about three-quarters full.' },
  ...
  {
    title: 'Tiramisu',
    description: 'Espresso-soaked ladyfingers layered with mascarpone cream and dusted with cocoa — the iconic Italian pick-me-up dessert.',
    cuisine: 'Italian',
    prep_minutes: 30,
    cook_minutes: 0,
    servings: 8,
    ...
    instructions: [
      { step_number: 1, instruction: 'Brew espresso and let it cool. Stir in coffee liqueur if using.' },
      { step_number: 2, instruction: 'Whisk egg yolks and sugar over a double boiler until thick, pale, and ribbon-like — about 5 minutes. Remove from heat.' },
      { step_number: 3, instruction: 'Fold mascarpone into the yolk mixture until smooth and creamy.' },
      { step_number: 4, instruction: 'In a separate bowl, whip heavy cream to stiff peaks. Gently fold whipped cream into the mascarpone mixture.' },
      { step_number: 5, instruction: 'Quickly dip each ladyfinger into the cooled espresso (don\'t soak too long) and arrange in a single layer in a 9×13 dish.' },
  ...
  {
    title: 'Berry Crumble',
    description: 'Juicy mixed berries bubbling under a buttery, oat-streusel topping — simple, rustic, and best served warm with ice cream.',
    cuisine: 'American',
    prep_minutes: 15,
    cook_minutes: 35,
    servings: 6,
    ...
    instructions: [
      { step_number: 1, instruction: 'Preheat oven to 375°F. Toss mixed berries with sugar, cornstarch, and lemon juice in a bowl; transfer to a 9-inch baking dish.' },
      { step_number: 2, instruction: 'In a separate bowl, combine oats, flour, brown sugar, and cinnamon.' },
      { step_number: 3, instruction: 'Cut cold butter into the oat mixture using a pastry cutter or your fingers until it resembles coarse crumbs with some pea-sized pieces.' },
      { step_number: 4, instruction: 'Scatter the crumble topping evenly over the berry filling.' },
      { step_number: 5, instruction: 'Bake 35 minutes until the topping is deep golden and the berry filling is bubbling around the edges.' },
      { step_number: 6, instruction: 'Cool for 10 minutes before serving. Serve warm with a scoop of vanilla ice cream or a dollop of whipped cream.' },
    ],
    tags: ['american', 'dessert', 'fruit', 'baked', 'comfort-food', 'family-friendly', 'vegetarian'],
    dietary_info: [
      { restriction: 'gluten-free', is_compliant: false },
      { restriction: 'dairy-free', is_compliant: false },
      { restriction: 'vegetarian', is_compliant: true },
