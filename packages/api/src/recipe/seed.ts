...
const recipes: SeedRecipe[] = [
  ...
  // ── Breakfast (3) ──────────────────────────────────────────────────────
  {
    ...
    description: 'Light and airy buttermilk pancakes stacked tall with maple syrup and a pat of butter — the classic American breakfast.',
    cuisine: 'American',
    prep_minutes: 10,
    cook_minutes: 15,
    servings: 4,
    ...
    instructions: [
      { step_number: 1, instruction: 'Whisk flour, sugar, baking powder, and salt together in a large bowl.' },
      { step_number: 2, instruction: 'In a separate bowl, beat eggs, then mix in buttermilk, melted butter, and vanilla.' },
      { step_number: 3, instruction: 'Pour wet ingredients into dry and stir gently until just combined — a few lumps are okay; do not overmix.' },
      { step_number: 4, instruction: 'Heat a lightly buttered griddle or skillet over medium heat. Pour ¼ cup batter per pancake; cook until bubbles form on the surface and edges set, about 2 minutes.' },
      { step_number: 5, instruction: 'Flip and cook 1–2 more minutes until golden brown. Serve stacked with maple syrup and butter.' },
    ],
  ...
  },
  {
    ...
    description: 'Thick brioche slices soaked in a vanilla-cinnamon egg custard and pan-fried to golden perfection — a cozy weekend breakfast.',
    cuisine: 'French',
    prep_minutes: 10,
    cook_minutes: 15,
    servings: 4,
    ...
    instructions: [
      { step_number: 1, instruction: 'Whisk eggs, milk, cinnamon, vanilla, and a pinch of salt in a shallow dish until smooth.' },
      { step_number: 2, instruction: 'Heat butter in a large skillet or griddle over medium heat.' },
      { step_number: 3, instruction: 'Dip each brioche slice into the egg mixture, letting it soak 10 seconds per side.' },
      { step_number: 4, instruction: 'Cook soaked slices 2–3 minutes per side until golden brown and slightly crisp on the edges.' },
      { step_number: 5, instruction: 'Serve immediately topped with maple syrup and a dusting of powdered sugar or fresh berries.' },
    ],
  ...
  },
  {
    ...
    description: 'Flour tortilla stuffed with scrambled eggs, crispy potatoes, chorizo, and salsa — a hearty whole30-friendly morning wrap (skip the tortilla for strict compliance).',
    cuisine: 'Mexican',
    prep_minutes: 10,
    cook_minutes: 15,
    servings: 4,
  ...
  {
    title: 'Minestrone',
    description: 'Hearty Italian vegetable soup loaded with beans, pasta, and seasonal vegetables in a tomato broth — a nourishing vegan staple.',
    cuisine: 'Italian',
    prep_minutes: 15,
    cook_minutes: 30,
    servings: 6,
    ...
    instructions: [
      { step_number: 1, instruction: 'Dice carrot, celery, zucchini, and onion into small uniform pieces.' },
      { step_number: 2, instruction: 'Sauté onion and garlic in olive oil until fragrant, about 3 minutes. Add carrot and celery; cook 5 minutes.' },
      { step_number: 3, instruction: 'Pour in diced tomatoes and vegetable broth; bring to a boil.' },
      { step_number: 4, instruction: 'Add zucchini, drained beans, and small pasta. Simmer 15 minutes until pasta and vegetables are tender.' },
      { step_number: 5, instruction: 'Season with salt, pepper, and a drizzle of olive oil. Serve with crusty bread.' },
    ],
    tags: ['italian', 'soup', 'vegan', 'dairy-free', 'vegetarian', 'comfort-food', 'family-friendly'],
    dietary_info: [
      { restriction: 'gluten-free', is_compliant: false },
      { restriction: 'dairy-free', is_compliant: true },
      { restriction: 'vegetarian', is_compliant: true },
  ...
  },
  {
    ...
    description: 'The ultimate comfort soup — tender chicken, egg noodles, carrots, and celery in a golden, savory broth.',
    cuisine: 'American',
    prep_minutes: 15,
    cook_minutes: 25,
    servings: 6,
    ...
    instructions: [
      { step_number: 1, instruction: 'Place chicken breast in a large pot with chicken broth; bring to a boil, then reduce to a simmer and cook 15 minutes until chicken is cooked through.' },
      { step_number: 2, instruction: 'Remove chicken and shred with two forks; set aside.' },
      { step_number: 3, instruction: 'Sauté diced onion, sliced carrots, and celery in the same pot with a drizzle of olive oil for 5 minutes.' },
  ...
  {
    title: 'Tom Yum Goong',
    description: 'Spicy and sour Thai soup with shrimp, mushrooms, lemongrass, and galangal — a paleo-friendly aromatic bowl.',
    cuisine: 'Thai',
    prep_minutes: 15,
    cook_minutes: 15,
    servings: 4,
    ...
    instructions: [
      { step_number: 1, instruction: 'Bruise lemongrass stalks with the back of a knife and slice galangal. Bring 4 cups of water or light chicken broth to a boil.' },
      { step_number: 2, instruction: 'Add lemongrass, galangal, and torn kaffir lime leaves (if available). Simmer 5 minutes to infuse aromatics.' },
  ...
  // ── Salads (2) ──────────────────────────────────────────────────────────
  {
    ...
    description: 'Crisp romaine lettuce tossed in a tangy garlic-anchovy dressing with crunchy croutons and shaved Parmesan.',
    cuisine: 'American',
    prep_minutes: 15,
    cook_minutes: 10,
    servings: 4,
    ...
    instructions: [
      ...
      { step_number: 2, instruction: 'Whisk anchovy paste, lemon juice, Dijon mustard, and egg yolk together in a bowl.' },
      { step_number: 3, instruction: 'Slowly drizzle in olive oil while whisking constantly to emulsify into a creamy dressing. Season with salt and pepper.' },
  ...
  {
    title: 'Cobb Salad',
    description: 'A loaded main-course salad with chicken, bacon, avocado, hard-boiled eggs, blue cheese, and a red-wine vinaigrette — keto perfection.',
    cuisine: 'American',
    prep_minutes: 20,
    cook_minutes: 15,
    servings: 4,
    ...
    instructions: [
      { step_number: 1, instruction: 'Season and grill or pan-sear chicken breast until cooked through, about 6 minutes per side. Slice into strips.' },
      { step_number: 2, instruction: 'Cook bacon until crispy; crumble into pieces. Hard-boil eggs 12 minutes, cool, peel, and quarter.' },
      { step_number: 3, instruction: 'Dice avocado and crumble blue cheese.' },
      { step_number: 4, instruction: 'Whisk red wine vinegar, olive oil, Dijon mustard, salt, and pepper into a vinaigrette.' },
      { step_number: 5, instruction: 'Arrange mixed greens on a platter. Arrange chicken, bacon, avocado, eggs, and blue cheese in neat rows over the greens.' },
  ...
  // ── More Desserts (2) ──────────────────────────────────────────────────
  {
    ...
    description: 'Dense, creamy cheesecake with a buttery graham cracker crust — the iconic rich and velvety American dessert.',
    cuisine: 'American',
    prep_minutes: 20,
    cook_minutes: 60,
    servings: 10,
    ...
    instructions: [
      { step_number: 1, instruction: 'Preheat oven to 350°F. Mix graham cracker crumbs with melted butter and 2 tbsp sugar; press into a 9-inch springform pan. Bake 10 minutes; cool.' },
      { step_number: 2, instruction: 'Beat cream cheese and remaining sugar until smooth and fluffy, about 3 minutes.' },
      { step_number: 3, instruction: 'Add eggs one at a time, mixing on low after each. Blend in sour cream, vanilla, and lemon juice until just combined — do not overmix.' },
      { step_number: 4, instruction: 'Pour filling over the cooled crust. Bake 55–60 minutes until edges are set but the center still has a slight jiggle.' },
  ...
  },
  {
    ...
    description: 'Silky coconut milk panna cotta set with agar and topped with fresh mango — a light, elegant, and entirely vegan Italian dessert.',
    cuisine: 'Italian',
    prep_minutes: 10,
    cook_minutes: 5,
    servings: 4,
    ...
    instructions: [
      { step_number: 1, instruction: 'Whisk coconut milk, sugar, and agar agar powder together in a saucepan.' },
      { step_number: 2, instruction: 'Bring to a boil over medium heat, whisking constantly. Boil 1 minute to fully activate the agar.' },
      { step_number: 3, instruction: 'Remove from heat and stir in vanilla extract. Pour into 4 ramekins or glasses.' },
